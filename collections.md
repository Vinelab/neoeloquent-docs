...
This method is especially useful in views when working with a grid system such as Bootstrap. Imagine you have a collection of NeoEloquent nodes you want to display in a grid:
